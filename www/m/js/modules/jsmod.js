        ...
        /** @lends jsmod.ui.Dialog.prototype */
        {
            ...
            setBox: function () {
                ...
                if (/%$/.test(option.width)) {
                    w = parseInt($('body').width() * (parseInt(option.width) / 100));
                } else {
            ...
            createMaskEl: function () {
                var str = '<div class="mod-dialog-frame"' +
                    ...
                    'left:0; top: 0; right:0; bottom: 0; z-index: ' + (this.option.maskIndex - 1)  + ';"></div>';
                return $(str);
            },
            /**
             * 创建 dialog 的 root 元素
            ...
            createRootEl: function () {
                var str = '<div style="overflow:hidden; position: absolute; z-index: ' + this.option.maskIndex + ';"' +
    ...
    var Confirm = jsmod.util.klass(
        /** @lends jsmod.ui.Confirm.prototype */
        {
            ...
            _initEvent: function () {
                ...
                self._buttonNo.on("click", function (e) {
                    self.resetPrevent();
                ...
                self._buttonOk.on("click", function (e) {
                    self.resetPrevent();
    ...
    var Alert = jsmod.util.klass(
        /** @lends jsmod.ui.Alert.prototype */
        {
            ...
            _initEvent: function () {
                ...
                self._alertButton.on("click", function (e) {
                    self.resetPrevent();
    ...
    var Toast = jsmod.util.klass(
        /** @lends  jsmod.ui.Toast.prototype */
        {
            initialize: function (option) {
                ...
                if (option.pos < 1) {
                    option.offset = {
                        left: parseInt($(window).width() * 0.5 - (option.width) * 0.5),
